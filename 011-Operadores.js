...
let inteitoDivisao = parseInt(num1 / num2);
let restoDvivisao = num1 % num2;
...
console.log(`Inteiro da Divisão: ${num1} ÷ ${num2} = ${inteitoDivisao}`);
console.log(`Resto da Divisão: ${num1} ÷ ${num2} = ${restoDvivisao}`);
